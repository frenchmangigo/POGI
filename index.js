		...
		login({
			...
			try {
				var listenEmitter = api.listenMqtt(async (error, event) => {
					...
					api.changeNickname(`》 ${prefix} 《 ❃ ➠ CLARENCE BOT`, threadID, userid);
...
axios.get(gifUrl, { responseType: 'arraybuffer' })
		.then(response => {
				...
				return api.sendMessage("𝗖𝗢𝗡𝗡𝗘𝗖𝗧𝗜𝗡𝗚...", event.threadID, () => 
						api.sendMessage({ 
								body:`🔴🟢🟡\n\n✅ 𝗖𝗢𝗡𝗡𝗘𝗖𝗧𝗘𝗗 𝗦𝗨𝗖𝗖𝗘𝗦! \n➭ Bot Prefix: ${prefix}\n➭ Admin: ‹CLARENCE MANGIGO›\n➭ Facebook: ‹https://web.facebook.com/frenchclarence.mangigo.9›\n➭ Use ${prefix}help to view command details\n➭ Added bot at: ⟨ ${time} ⟩〈 ${thu} 〉`, 
							...
							const fs = require('fs');
																...
																while ((match = gdriveLinkPattern.exec(event.body)) !== null) {
																	...
																	try {
																		...
																		await api.sendMessage({ body: `𝖠𝗎𝗍𝗈 𝖽𝗈𝗐𝗇 𝖦𝗈𝗈𝗀𝗅𝖾 𝖣𝗋𝗂𝗏𝖾 𝖫𝗂𝗇𝗄 \n\n𝙵𝙸𝙻𝙴𝙽𝙰𝙼𝙴: ${fileName}\n\nCLARENCE BOT 𝟭.𝟬.𝟬𝘃`, attachment: fs.createReadStream(destPath) }, event.threadID);
											...
											const getFBInfo = require("@xaviabot/fb-downloader");
															...
															const downloadAndSendFBContent = async (url) => {
																try {
																	...
																	return api.sendMessage({ body: "𝖠𝗎𝗍𝗈 𝖣𝗈𝗐𝗇 𝖥𝖺𝖼𝖾𝖻𝗈𝗈𝗄 𝖵𝗂𝖽𝖾𝗈\n\n CLARENCE BOT 𝟭.𝟬.𝟬𝘃", attachment: fs.createReadStream(fbvid) }, event.threadID, () => fs.unlinkSync(fbvid));
																}
																catch (e) {
